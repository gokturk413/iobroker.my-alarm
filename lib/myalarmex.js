   ...
   function dbgetAlarm (callback) {
    ...
    function dbDeleteAlarm(alarmid,tagname) {
        ...
        db.run(sql, [alarmid], function(err) {
            ...
            console.log(`Rows inserted ${this.changes}`);
            adapter.delForeignObject('my-alarm.0.'+tagname+"_High", function(callback){
                
            });
            adapter.delForeignObject('my-alarm.0.'+tagname+"_Low", function(callback){
   ...
   function SetObjectFromJson(element)
    {
        if (element.HighRefTagName != null) {
            ...
            adapter.setForeignState('my-alarm.0.'+element.HighRefTagName, {val: '0', ack: true});
        }
        if (element.LowRefTagName != null) {
            ...
            adapter.setForeignState('my-alarm.0.'+element.LowRefTagName, {val: '0', ack: true});
        }  
    }
